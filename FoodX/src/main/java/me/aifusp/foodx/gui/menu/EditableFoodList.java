...
public class EditableFoodList {
    ...
    public EditableFoodList(Player staff, int pageNumber) {
        this.staff = staff;
    ...
    public void createInventory() {
        inventory = Bukkit.createInventory(staff, InventoryName.EDITABLE_FOOD_LIST.getSize(), InventoryName.EDITABLE_FOOD_LIST.getName());
